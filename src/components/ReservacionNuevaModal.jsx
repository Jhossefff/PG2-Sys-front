...
export default function ReservacionNuevaModal({
  ...
  empresas = [], clientes = [], lugares = [], tarifas = [], usuarios = [],
}) {
  ...
  useEffect(() => { if (show) { setForm(initialForm); setValidated(false); } }, [show]);
  ...
  return (
    <Modal show={show} onHide={onHide} backdrop="static" size="lg">
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Modal.Header closeButton><Modal.Title>Nueva Reservación</Modal.Title></Modal.Header>
        <Modal.Body>
          ...
          <Row className="g-3">
            ...
            <Col md={6}>
              <Form.Group>
                ...
                <Form.Text className="text-muted">Se enviará como "YYYY-MM-DDTHH:mm:00" (sin Z).</Form.Text>
